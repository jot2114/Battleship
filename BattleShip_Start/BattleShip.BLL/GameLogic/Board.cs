...
namespace BattleShip.BLL.GameLogic
{
    public class Board
    {
        ...
        /// Keeps record of all shots fired/missed/hit And boat location
        public Board()
        {
        ...
        //I created it, to use ship array which is private
        public Ship[] GetShips()
        {
            return _ships;
        }
        ///Verifies the result of a shot fired by the player
        ...
        /// Takes in coordinate & shot response as parameter & Checks to see if a ship has been hit
        ...
        // / PlaceShipRequest as  aparameter: This consists of three things: coordinate location, direction, and ship type..
        // /Contains a switch that calls the direction methods based on the direction the player wants the ship;
        ///Calls the methods AddShipToBoard() and OverlapsAnotherShip
        /// 
